...
public class StudentsCRUDTest extends TestBase {
	...
	public void test001(){
		...
		.assertThat().body(containsString("Student added"));;
		

	}
	
	@Title("This test will create a new student whith same email")
	@Test
	public void test005(){
		ArrayList<String> courses = new ArrayList<String>();
		courses.add("JAVA");
		...
		steps.createStudent(firstName, lastName, "egestas.rhoncus.Proin@massaQuisqueporttitor.org", programme, courses)
		.statusCode(500)
		.spec(ReuseableSpecifications.getGenericResponseSpec())
		.assertThat().body(containsString("Email address already"));
